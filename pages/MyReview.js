...
const MyReview = () => {
    ...
    const getReviews = async () => {
        const response = await fetch(
            `${process.env.NEXT_PUBLIC_MY_BACK_HOST}/product/getMyreviews/`,
            {
                method: "GET",
                headers: {
                                ...
                                {reviews.length !== 0 && reviews.map((i) => {
                                    return (
                                        <Link key={i} href={"/product/" + i.product} passHref>
                                            <a>
                                                <div class="container w-100 lg:w-5/6 mx-auto flex flex-col">
                                                    <div v-for="card in cards" class="flex flex-col md:flex-row overflow-hidden bg-white rounded-lg shadow-xl  mt-4 w-100 mx-2">
                                                        ...
                                                        <div class="h-64 w-auto md:w-1/2">
                                                            <Image className="h-24 rounded-lg"
                                                                src={`${process.env.NEXT_PUBLIC_MY_BACK_HOST}${i.product__image}`}
                                                                height={400}
                                                                width={400}
                                                                alt={i.product_name} />
                                                        </div>
                                                        ...
                                                        <div class="w-full py-4 px-6 text-gray-800 flex flex-col justify-between">
                                                            ...
                                                            <h3 class="font-semibold text-lg leading-tight truncate">{capFirstLetter(i.title)}</h3>
                                                            <p class="mt-2">
