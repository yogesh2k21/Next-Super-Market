...
const Product = ({
  ...
  return (
    <>
      <section className="text-gray-600 bg-gray-100 body-font min-h-screen overflow-hidden py-6">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex mt-2">
                ...
                {cartButtonState && (
                  <button
                    disabled={cartButtonState}
                    className="flex ml-auto text-white bg-slate-400 border-0 py-2 px-6 focus:outline-none hover:bg-grey-600 rounded"
                  >
                    Added
                  </button>
                )}
