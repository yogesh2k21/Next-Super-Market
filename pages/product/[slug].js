...
const product=null;
for (let index = 0; index < products.length; index++) { if(products[index]['title']==slug){ product=products[index];
  break; } } return <>
    ...
    <div className="container px-5 py-24 mx-auto">
      <div className="lg:w-4/5 mx-auto flex flex-wrap">
        <Image alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded"
          src={"/images/"+product.filename} width={400} height={485} />
        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
          <h2 className="text-sm title-font text-gray-500 tracking-widest">{product.type.toUpperCase()}</h2>
